...
exports.streamFile = function (filepath, headerFields, stat, res, req, emitter) {
  ...
  process.nextTick( function() {
    ...
    if (statCode == 304) {
      ...
      /*According to the performance tests I've run 64KiB is optimal for both
        the buffer size and chunk size. See: http://blog.andrewvc.com/node-js-and-binary-data
        for more info about this. Since Buffers are new, and this might change in the relative close
        future, I'm going to leave this more flexible code in  */
